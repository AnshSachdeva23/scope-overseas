...
const Headings = () => {
  ...
  return (
    <div
      id="home"
      className="relative z-10 flex flex-col justify-center items-center h-full text-center px-4 mt-40 mb-16"
    >
      ...
      <div className="mb-10 flex gap-4">
        ...
        <button className="relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium text-[#4B3621] rounded-lg group bg-gradient-to-br from-[#D2B48C] to-[#C49A6C] hover:from-[#c49a6c] hover:to-[#a87b4c] focus:ring-4 focus:outline-none focus:ring-yellow-200" onClick={redirectToAboutPage}>
